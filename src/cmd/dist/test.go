...
func (t *tester) extLink() bool {
	...
	case "aix-ppc64",
		...
		"linux-386", "linux-amd64", "linux-arm", "linux-arm64", "linux-ppc64le", "linux-mips64", "linux-mips64le", "linux-mips", "linux-mipsle", "linux-riscv64", "linux-s390x", "linux-sw64",
...
func (t *tester) internalLink() bool {
	...
	if goarch == "mips64" || goarch == "mips64le" || goarch == "mips" || goarch == "mipsle" || goarch == "riscv64" || goarch == "sw64" {
		return false
	}
	if goos == "aix" {
...
func (t *tester) supportedBuildmode(mode string) bool {
	...
	case "c-archive":
		...
		case "aix-ppc64",
			...
			"linux-amd64", "linux-386", "linux-ppc64le", "linux-s390x", "linux-sw64",
			"freebsd-amd64",
	...
	case "plugin":
		...
		switch pair {
		case "linux-386", "linux-amd64", "linux-arm", "linux-s390x", "linux-ppc64le", "linux-sw64":
			return true
		case "darwin-amd64", "darwin-arm64":
			return true
		case "freebsd-amd64":
...
func (t *tester) cgoTest(dt *distTest) error {
	...
	case "aix-ppc64",
		...
		"dragonfly-amd64",
		"freebsd-386", "freebsd-amd64", "freebsd-arm",
		"linux-386", "linux-amd64", "linux-arm", "linux-arm64", "linux-ppc64le", "linux-riscv64", "linux-s390x", "linux-sw64",
		"netbsd-386", "netbsd-amd64",
